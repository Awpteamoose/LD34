...
public static class Beholder
{
	...
	{
		_subscriptions = new Dictionary<string, List<object>>();
	}
	...
	private static void _Trigger<T1, T2, T3, T4, T5>(string key, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5)
	{
		...
		foreach (Callback<T1, T2, T3, T4, T5> cb in _subscriptions[key].ToList())
		{
	...
	private static void _Observe<T1, T2, T3, T4, T5>(string key, Callback<T1, T2, T3, T4, T5> cb, Subscription sub)
	{
		...
		if (sub != null) sub.items.Add(key, cb);
	}
	...
	{
		foreach (var kv in sub.items)
		{
			_subscriptions[kv.Key].Remove(kv.Value);
			if (_subscriptions[kv.Key].Count == 0) _subscriptions.Remove(kv.Key);
		}
	}
	...
	public delegate void Callback<in T1, in T2, in T3>(T1 arg1, T2 arg2, T3 arg3);
	public delegate void Callback<in T1, in T2, in T3, in T4>(T1 arg1, T2 arg2, T3 arg3, T4 arg4);
	public delegate void Callback<in T1, in T2, in T3, in T4, in T5>(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5);
